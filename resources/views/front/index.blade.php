...
{{-- This is the default ||Smaster|| home page and is rendered by index() method in Front/IndexController.php as --}}
...
@section('content')
    ...
    <div class="container">
        <ul class="nav tab-nav-style-1-a justify-content-center">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#men-best-selling-products">Best Sellers</a>
            </li>
        </ul>
        <div class="slider-fouc">
            <div class="products-slider owl-carousel" data-item="4">
    ...
    <div class="container">
        <ul class="nav tab-nav-style-1-a justify-content-center">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#discounted-products">Discounted Products</a>
            </li>
        </ul>
        <div class="slider-fouc">
            <div class="products-slider owl-carousel" data-item="4">
    ...
    <div class="container">
        <ul class="nav tab-nav-style-1-a justify-content-center">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#men-featured-products">Featured Products</a>
            </li>
        </ul>
        <div class="slider-fouc">
            <div class="products-slider owl-carousel" data-item="4">
