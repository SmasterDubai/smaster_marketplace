    						...
    						<tbody>
                                ...
                                @foreach ($orderDetails['orders_products'] as $product)
                                    <tr>
                                        ...
                                        <td class="text-center">AED {{ $product['product_price'] }}</td>
                                        <td class="text-center">{{ $product['product_qty'] }}</td>
                                        <td class="text-right">AED {{ $product['product_price'] * $product['product_qty'] }}</td>
                                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="thick-line text-right">AED {{ $subTotal }}</td>
                                </tr>
                                <tr>
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                ...
                                <tr>
                                    ...
                                    <td class="no-line text-right">
                                        <strong>AED {{ $orderDetails['grand_total'] }}</strong>
                                        <br>
